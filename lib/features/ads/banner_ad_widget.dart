...
/// * When Premium is off it loads a banner immediately and shows a compact,
///   thematically muted placeholder while loading so the layout does not jump.
...
class _VoraTubeBannerAdState extends ConsumerState<VoraTubeBannerAd> {
  ...
  void _loadAd() {
    ...
    debugPrint(
      'VoraTubeAds: banner load requested (unit $adUnitId, premium off)',
    );
    late BannerAd ad;
    ad = BannerAd(
      adUnitId: adUnitId,
