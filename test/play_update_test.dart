...
Widget host(FakePlayUpdateApi api, FakePlayUpdateStore store) {
  return ProviderScope(
    ...
    child: const MaterialApp(
      home: PlayUpdateHost(child: Scaffold(body: SizedBox.shrink())),
    ),
  );
}
...
void main() {
  ...
  group('PlayUpdateHost', () {
    ...
    testWidgets('downloaded update shows the restart banner', (tester) async {
      await tester.pumpWidget(
        host(
          FakePlayUpdateApi(
    ...
    testWidgets('Restart & Update completes the update', (tester) async {
